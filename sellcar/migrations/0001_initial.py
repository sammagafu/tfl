# Generated by Django 3.2 on 2021-10-06 08:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sellcar.carmodel', verbose_name='')),
                ('features', models.ManyToManyField(blank=True, null=True, to='sellcar.CarFeatures', verbose_name='features')),
            ],
            options={
